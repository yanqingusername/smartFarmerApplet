...
Page({
    ...
    getPigAlarm:function(page){
        ...
        var data = {
            ...
            type:"1", //0全部 1未处理 2处理的，其中未处理状态可能存在自动恢复需要标记出来
        }
    ...
    deal_pig:function(e){
        var log_id = e.currentTarget.dataset.id;
        wx.navigateTo({
            url: '/pages/abnormal/pig_alarm_deal?log_id=' + log_id,
        })
    },
    //********上拉加载**************************************
    onReachBottom() {
